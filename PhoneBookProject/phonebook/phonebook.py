...
def search_record_by_value(user_value: str, records: list) -> dict:
...
def add_record(file_path: str, records: list, new_entry: dict) -> None:
    """Adds new entry"""
...
def delete_record_by_phone(file_path: str, records: list, phone_number: str) -> None:
    ...
    record = search_record_by_value(phone_number, records)
    ...
    while True:
        ...
        with open(file_path) as f:
            ...
            if option == "search":
                ...
                print(f"Found: {search_record_by_value(search_by, records)}")
            if option == "delete":
            ...
            if option == "add":
                ...
                add_record(file_path, records, entry)